...
const SAMPLE_TOPICS = [
  ...
  { title: "LinkedIn Algorithmus Update Q1 2026", summary: "LinkedIn belohnt jetzt laengere Verweildauer staerker als Likes. Posts mit Storytelling performen 3x besser als reine Fakten-Posts.", url: "https://example.com/linkedin-algo" },
  { title: "Remote Work vs. Office: Die grosse Debatte 2026", summary: "Neue Studien zeigen: Hybrid-Modelle mit 2-3 Buerotagen pro Woche maximieren Produktivitaet und Mitarbeiterzufriedenheit.", url: "https://example.com/remote-work" },
  ];
